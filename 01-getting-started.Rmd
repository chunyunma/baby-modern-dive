...
the *console pane*, the *files pane*, and the *environment pane*. 
...
Buckle up. The ride is about to get wild. 
...
It is recommended that you group these files into *project folders*. 
Each folder corresponds to one project. 
A project could be a dataset you need to analyze for a course, 
or your entire thesis. 
...
Let's start by creating the second project folder, and 
...
We have completed the first step in our workflow 101. 
Next on the agenda is `renv`. 
...
follow the steps described in xx to install the latest version of R. 
