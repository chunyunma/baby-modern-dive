...
as far as income prospect goes.
...
`r knitr::asis_output("\u0024")` (US dollar), 
`r knitr::asis_output("\u20AC")` (Euro), 
`r knitr::asis_output("\u00A5")` (Yen), ...
...
is the most difficult aspect of sample size planning. 
...
It is okay if the effect size ends up being larger in the actual study.
