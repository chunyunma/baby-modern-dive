...
<p class="bg-danger">
This chapter is still in draft mode!
Be prepared to read it again once it has been finalized.
</p>

Now that we have learned the fundamentals of inferential statistics, 
let's proceed with one of the most common data modelling techniques: 
linear regression.
...
in Chapters \@ref(clt), \@ref(confidence-intervals), 
