...
and advanced math skill is not an requirement. 
...
I heard about R for the first time at a Christmas party, perhaps 7-8 years ago. 
...
I needed to run some analyses that I only knew then how to do in SAS. 
...
It would allow me to run the indended analysis properly, it is cross-platform, 
it is free, 
and what better opportunity to learn a new toy 
than while working on a PhD dissertation?
...
provided that the source code has not be modified. 
...
instead of a nice single, unified, simple identity. 
...
+ Email. I respect that some of you still prefer emails to other tools. 
  ...
  so that I can response in a thoughtful way. 
...
Let's face it. 
Online class is not one of the most absorbing activities you have done. 
...
your classmates cannot peer behind you 
and be distracted by the facebook page on your screen. 
However, I do encourage you to use some discipline 
...
<!-- a datacamp module before lecture 2 on ggplot [ ] -->
